...
1) Состояниями всех процессов и всех каналов, входящих в её состав.
...
3) Уникальный объект, который процессы передают друг другу с помощью сообщения.
...
3) Если "что-то хорошее рано или поздно случится".

## 7) Приложение можно разделить на следующие:

1) Средства представления, логика представления, прикладная логика.
...
3) Клиент сетевой файловой системы, протокол клиент-сервер сетевой файловой системы.
...
2) В текстовом виде по одной команде в строке.
...
3) Позволить произвольной группе пользователей разделять общую файловую систему.
